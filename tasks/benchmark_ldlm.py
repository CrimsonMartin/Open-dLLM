...
ENCODER_NAME = "/home/johndpope/qwen36_27b_local"
WARMUP_ITERS = 3
BENCH_ITERS = 20
...
print("Building LDLM autoencoder (encoder on CPU, trainable on GPU)...")
...
torch.save(state, os.path.join(save_dir, "ldlm_untrained.pt"))
print(f"Saved to {save_dir}/ldlm_untrained.pt")
